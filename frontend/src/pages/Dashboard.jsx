...
const Dashboard = () => {
	...
	const [getKey, showGetKey] = useState(true); // state to show/hide the key modal
	...
	return (
		<>
		{getKey && <KeyModal text="Enter the encryption key" checked={false} onSubmit={showGetKey} file={file} />}
